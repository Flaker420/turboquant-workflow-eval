        ...
        for row in prompt_rows:
            lines.extend(
                [
                    ...
                    f"- Tokens/sec: {'n/a' if row['tokens_per_second'] is None else f'{row['tokens_per_second']:.4f}'}",
                    f"- Peak VRAM (GB): {'n/a' if row['peak_vram_gb'] is None else f'{row['peak_vram_gb']:.4f}'}",
                    "",
                    "```text",
                    row["output_text"] or "",
                    "```",
